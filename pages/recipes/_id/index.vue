    ...
    <main class="container my-5">
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <img class="img-fluid" style="width: 400px; border-radius: 10px; box-shadow: 0 1rem 1rem rgba(0,0,0,.7);" :src="recipe.picture" alt="recipe.name">
            </div>
            <div class="col-md-6">
